...
const navItems = [
  ...
  },
  {
    ...
    to: "/gallery",
    subItems: [
      { label: "Kitchen Remodeling", to: "/gallery/kitchen" },
      { label: "Bathroom Remodeling", to: "/gallery/bathroom" },
      { label: "Residential Remodeling", to: "/gallery/residential" },
      { label: "Video", to: "/gallery/video" },
      { label: "All Photos", to: "/gallery/all-photos" },
    ],
  },
