...
export function FinancingSection() {
  return (
    <section className="bg-gradient-brand-light bg-background py-[40px] md:py-[60px] px-4 md:px-8 mx-[15px] mt-[15px] rounded-[10px]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        {/* Left Content */}
        <div className="w-full lg:w-1/2 flex flex-col">
          <div className="inline-flex rounded-full bg-gradient-to-r from-charcoal to-copper mb-6 self-start shadow-sm">
          ...
          <p className="text-gray-700 text-lg mb-8 max-w-lg leading-relaxed font-medium">
            We believe your dream project shouldn't wait. That's why we partner with top local and
            national lenders to offer flexible, competitive financing options tailored to your
            budget.
          </p>
          ...
          <ul className="space-y-5 mb-10">
            {[
              ...
              <li
                key={idx}
                className="flex items-center gap-4 text-[#0F172A] font-semibold text-[17px]"
              >
          ...
          <button className="w-fit px-8 py-3.5 rounded-full bg-charcoal hover:bg-[#0D2241] text-white font-bold text-[15px] transition-colors shadow-lg">
            Apply For Financing
          </button>
        </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 text-white">
                ...
                <p className="text-white/80 text-sm">
                  Available for qualified buyers on select projects. Ask our team for details during
                  your estimate.
                </p>
              </div>
            </div>
