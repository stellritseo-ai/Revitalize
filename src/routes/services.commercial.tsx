...
export const Route = createFileRoute("/services/commercial")({
  head: () => ({
    title:
      "Commercial Services – Office Build-Outs, Tenant Improvements & Commercial Construction | Certified Commercial Building Contractor | Licensed & Insured",
    meta: [
      {
        name: "description",
        content:
...
function CommercialServicesPage() {
  ...
  return (
    <main className="bg-[#F8FAFC] overflow-x-hidden">
        ...
        >
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 md:p-16 rounded-[2rem] shadow-2xl text-center">
            ...
            <p className="text-white/80 text-lg md:text-xl max-w-4xl mx-auto mb-10 leading-relaxed font-medium">
              Under our Florida Certified General Contractor (CGC) License (B-1 General Commercial),
              Arizona Premiere Construction Group delivers professional commercial construction,
              remodeling, and tenant improvements across the Tampa Bay area. We manage your project
              from start to finish. <span className="text-white font-bold">Licensed & Insured</span>
              .
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <Link
                to="/contact"
                className="w-full sm:w-auto bg-white hover:bg-gray-100 text-charcoal px-10 py-5 rounded-full font-bold text-lg flex items-center justify-center gap-2 transition-all hover:scale-105 shadow-xl"
              >
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20 relative z-10">
          <div className="lg:w-1/2">
            ...
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
              <p>
                Your commercial space is more than a building — it's your brand, your employees'
                workplace, and your customers' first impression. At Revitalize Real Estate Group, we
                treat it with the professionalism it deserves. Under our B-1 General Commercial
                Contractor license (part of the AZ CGC Dual License), we are authorized to construct
                commercial buildings, remodel existing properties, perform tenant improvements, and
                manage full-scale commercial projects.
              </p>
              <p className="font-bold text-charcoal">
                We are fully licensed (Licensed & Insured), insured, and bonded. As your General
                Contractor (GC) , we provide a single point of contact — overseeing every trade,
                managing budgets, and ensuring on-time delivery. No subcontractor chaos. No project
                delays. Just results.
              </p>
            </div>
          </div>
      ...
      <section className="py-[100px] px-4 md:px-8 bg-charcoal mx-[15px] rounded-[20px] text-white">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            },
            {
              ...
              desc: "Fix structural issues, roof damage, flooring problems, and exterior deterioration.",
              icon: <ShieldCheck />,
            },
            {
              title: "Construction Management",
              desc: "We supervise every trade, manage budgets, schedule inspections, and ensure on-time delivery.",
              icon: <HardHat />,
            },
            {
              title: "Subcontractor Coordination",
              desc: "We hire and manage all specialty trades (electrical, plumbing, HVAC) so you don't have to.",
              icon: <Users />,
            },
          ].map((item, i) => (
            <div
              key={i}
              className="bg-white/5 backdrop-blur-md p-8 rounded-[2rem] border border-white/10 hover:border-brand-orange hover:bg-white/10 transition-all duration-300 group flex flex-col h-full"
            >
              ...
              <p className="text-white/70 font-medium leading-relaxed text-sm flex-grow">
                {item.desc}
              </p>
            </div>
          ))}
      ...
      <section className="py-[100px] px-4 md:px-8 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">
              Detailed Commercial Capabilities
            </span>
            <h2 className="text-4xl md:text-5xl font-black text-[#1E110A] mb-6">
              Full-Service Commercial General Contracting
            </h2>
            <p className="text-gray-500 text-lg max-w-3xl mx-auto">
              As your General Contractor (GC), we manage every phase of your commercial project —
              from initial consultation to final walkthrough. We coordinate all licensed
              subcontractors for specialty trades while self-performing key structural work.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-[2rem] p-8 shadow-sm">
              <h3 className="text-2xl font-black text-charcoal mb-8 flex items-center gap-3">
              ...
              <div className="space-y-6">
                {[
                  {
                    title: "Framing",
                    desc: "Structural walls, roof framing, and commercial-grade framing",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: "Commercial roof replacement, repair, and maintenance",
                  },
                  {
                    title: "Flooring Installation",
                    desc: "Hardwood, tile, laminate, vinyl, carpet — commercial-grade materials",
                  },
                  {
                    title: "Interior & Exterior Painting",
                    desc: "Professional finishes for offices, retail, and industrial spaces",
                  },
                  {
                    title: "Concrete Work",
                    desc: "Foundations, slabs, walkways, and parking lot repairs",
                  },
                  {
                    title: "Exterior Improvements",
                    desc: "Siding, stucco, storefront facades, and curb appeal upgrades",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex gap-4 items-start border-b border-gray-200 pb-4 last:border-0 last:pb-0"
                  >
            ...
            {/* Coordinated */}
            <div className="bg-charcoal border border-blue-900 rounded-[2rem] p-8 shadow-2xl text-white relative overflow-hidden">
              ...
              <div className="space-y-6 mb-8 relative z-10">
                {[
                  {
                    title: "Electrical",
                    desc: "Wiring, panels, lighting fixtures, data cabling, and code compliance",
                    icon: <Zap />,
                  },
                  {
                    title: "Plumbing",
                    desc: "Pipe installation, restrooms, breakrooms, water heaters, and drainage",
                    icon: <Droplets />,
                  },
                  {
                    title: "HVAC / Air Conditioning",
                    desc: "Heating, cooling, ductwork, ventilation, and commercial HVAC systems",
                    icon: <Thermometer />,
                  },
                  {
                    title: "Fire Protection Systems",
                    desc: "Sprinkler systems and fire alarms (coordinated with licensed specialists)",
                    icon: <Flame />,
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex gap-4 items-start bg-white/5 p-6 rounded-2xl border border-white/10 hover:border-brand-orange/50 transition-colors"
                  >
              ...
              <div className="bg-brand-orange/10 border border-brand-orange/30 p-5 rounded-xl relative z-10">
                <p className="text-sm font-bold text-white/90 leading-relaxed">
                  <span className="text-brand-orange uppercase tracking-widest mr-2 block mb-1 text-xs">
                    Important Note
                  </span>
                  All subcontractors are licensed, insured, and vetted by us. You never manage them
                  directly — we do.
                </p>
              </div>
            </div>
      ...
      <section className="py-[100px] px-4 md:px-8 bg-gray-50 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white border border-gray-200 rounded-[2rem] overflow-hidden shadow-xl">
            <div className="grid grid-cols-1 md:grid-cols-2 bg-charcoal p-6 border-b border-charcoal">
              <div className="font-black text-white uppercase text-sm tracking-wider hidden md:block">
                Project Type
              </div>
              <div className="font-black text-white uppercase text-sm tracking-wider hidden md:block">
                Examples
            ...
            {[
              ...
              },
              {
                ...
                examples: "Quick-service restaurants, cafes, coffee shops, commercial kitchens",
              },
              {
                type: "Warehouse & Industrial",
                examples: "Storage facilities, distribution centers, light industrial spaces",
              },
              {
                type: "Medical & Dental Offices",
                examples: "Exam rooms, reception areas, private offices, treatment rooms",
              },
              {
                type: "Tenant Improvements",
                examples: "Leased space customization — new walls, flooring, lighting, restrooms",
              },
              {
                type: "Commercial Remodels",
                examples:
                  "Layout changes, modern finishes, updated storefronts, accessibility upgrades",
              },
              {
                type: "Property Repairs",
                examples:
                  "Roof replacement, concrete repair, structural fixes, exterior restoration",
              },
            ].map((item, i) => (
              <div
                key={i}
              ...
              >
                <div className="font-black text-charcoal">{item.type}</div>
      ...
      <section className="py-[100px] px-4 md:px-8 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-charcoal mb-16">
            Why Businesses Trust Revitalize Real Estate
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              {
                title: "B-1 General License",
                desc: "Authorized for commercial construction, remodeling, tenant improvements",
                icon: <BadgeCheck />,
              },
              {
              ...
              },
              {
                ...
                desc: "We know Arizona commercial codes, permits, and regulations",
                icon: <Clock />,
              },
              {
                title: "Minimal Disruption",
                desc: "We work efficiently to keep your business operational",
                icon: <Building2 />,
              },
              {
              ...
              {
                title: "Coordinate Subs",
                desc: "Electrical, plumbing, HVAC, fire protection",
                icon: <Settings />,
              },
              {
              ...
              },
              {
                ...
                desc: "Flexible options for qualifying commercial projects",
                icon: <TrendingUp />,
              },
              {
              ...
              <div
                key={i}
                className="bg-gray-50 p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:border-brand-orange hover:bg-white transition-all group"
              >
                <div className="bg-charcoal/10 w-12 h-12 rounded-xl flex items-center justify-center mb-4 mx-auto text-charcoal group-hover:bg-brand-orange group-hover:text-white transition-all">
                  {React.cloneElement(benefit.icon as React.ReactElement, { className: "w-6 h-6" })}
                </div>
                <h3 className="text-sm font-black text-charcoal mb-2">{benefit.title}</h3>
      ...
      <section className="py-[100px] px-4 md:px-8 bg-gray-50 border-y border-gray-200">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#1E110A] mb-6">
              Simple, Professional Commercial Construction Management
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium">
              No runaround. No hidden fees. Just three straightforward steps from consultation to
              completed commercial space.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
            <div className="absolute top-1/2 left-0 w-full h-1 bg-gray-200 -translate-y-1/2 hidden lg:block overflow-hidden">
              <div className="h-full bg-charcoal w-1/3 animate-marquee" />
            </div>
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-3 bg-gray-50 px-8 py-5 rounded-3xl border border-gray-200 hover:border-brand-orange transition-all group cursor-default"
              >
      ...
      <section className="py-[100px] px-4 md:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <Accordion.Root type="single" collapsible className="space-y-4">
            {[
              {
                q: "What is a Certified Commercial Building Contractor?",
                a: "A B-1 license allows a contractor to construct commercial buildings, remodel commercial properties, perform tenant improvements, and manage commercial construction projects. We hold this license as part of our AZ CGC Dual License (Licensed & Insured).",
              },
              {
                q: "Can you build a new office or retail space for me?",
                a: "Yes. We handle new commercial construction from permits to final walkthrough.",
              },
              {
                q: "Do you perform electrical, plumbing, or HVAC work yourselves?",
                a: "No. Under Arizona regulations, our license requires us to subcontract electrical, plumbing, HVAC, and fire protection to properly licensed specialists. We manage them for you.",
              },
              {
                q: "How long does an office build-out take?",
                a: "Typically 4–12 weeks depending on scope and square footage. We provide a clear timeline before any work begins.",
              },
              {
                q: "Can my business remain open during construction?",
                a: "In many cases, yes. We develop a construction phasing plan to minimize disruption to your customers and employees.",
              },
              {
              ...
              },
              {
                ...
                a: "Yes. We obtain all necessary permits for commercial construction, remodeling, and tenant improvement projects.",
              },
            ].map((item, i) => (
              <Accordion.Item
                key={i}
                value={`item-${i}`}
                className="bg-gray-50 border border-gray-200 rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-shadow"
              >
                <Accordion.Header>
      ...
      {/* 10. Quote Form */}
      <section className="py-[100px] px-4 md:px-8 mx-[15px] mb-[15px] rounded-[20px] bg-charcoal border border-blue-900 shadow-2xl relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 relative z-10">
          <div className="lg:w-5/12 text-white">
            <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">
              Request a Quote – Commercial Services
            </span>
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-bold text-lg">info@revitalizerealestate.com</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-6 relative">
              ...
              <div className="md:col-span-2 p-8 border-2 border-dashed border-gray-200 rounded-[2rem] bg-gray-50 flex flex-col items-center justify-center gap-4 group hover:border-brand-orange transition-colors cursor-pointer">
                ...
                <div className="text-center">
                  <p className="font-black text-gray-500">
                    Upload Blueprints, Photos, Layout Sketches
                  </p>
              ...
              <div className="md:col-span-2 space-y-4 pt-4">
                ...
                <label className="flex items-center gap-4 cursor-pointer group">
                  ...
                  <span className="text-sm font-bold text-gray-600 group-hover:text-charcoal transition-colors">
                    My business needs to remain open during construction
                  </span>
                </label>
              </div>
