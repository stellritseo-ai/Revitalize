...
export const Route = createFileRoute("/services/residential")({
  head: () => ({
    title: "Residential Remodeling | Revitalize Real Estate – Tampa Bay's Home Transformation Experts",
    meta: [
      {
        name: "description",
        content:
          "Transform your home with expert residential remodeling services in Tampa Bay. From whole-home renovations to room additions, Revitalize Real Estate delivers quality craftsmanship. Serving within 50 miles. Free estimates.",
      },
    ],
  }),
  component: ResidentialRemodelingPage,
});
...
const benefits = [
  {
    ...
    desc: "Veteran builders who know how to handle any challenge",
  },
  {
    icon: Home,
...
const servicesDetail = [
  {
    ...
    desc: "Completely reimagine your living space with a full home remodel. We handle everything from layout changes and structural updates to finishes and fixtures, creating a cohesive, modern home that reflects your style.",
    icon: Home,
    image: resOne,
    bullets: [
      "Open concept floor plans",
      "Interior wall removal and additions",
  ...
  {
    title: "Room Additions & Extensions",
    desc: "Need more space? We design and build seamless room additions that blend perfectly with your existing home. Whether you need an extra bedroom, home office, or expanded living area, we deliver beautiful, functional spaces.",
    icon: PlusCircle,
    image: realEstateImg,
    bullets: [
      "Bedroom additions",
  ...
  },
  {
    ...
    desc: "Safety and stability are the foundation of every great home. Our team handles all structural and foundation work with precision and expertise, ensuring your home is safe, sound, and built to last.",
    icon: Building,
  ...
  {
    title: "Exterior Remodeling & Curb Appeal",
    desc: "Make a lasting first impression with expert exterior remodeling. From siding and roofing to windows and doors, we enhance your home's curb appeal and energy efficiency.",
    icon: Hammer,
  ...
  {
    title: "Interior Remodeling & Finishes",
    desc: "Transform the inside of your home with premium interior remodeling services. We specialize in creating beautiful, functional interiors that match your lifestyle and taste.",
    icon: Sparkles,
    image: cabinetImg,
    bullets: [
...
const processSteps = [
  {
    ...
    desc: "Tell us about your project—no obligation, no pressure. We'll provide clear, transparent pricing to help you plan.",
  },
  {
    step: "Step 02",
...
const recentProjects = [
  { type: "Whole-Home Renovation", location: "Tampa, FL 33647", scope: "Complete interior remodel, open concept layout, custom finishes" },
  { type: "Room Addition", location: "Wesley Chapel, FL", scope: "New master bedroom and en-suite bathroom addition" },
  { type: "Structural Renovation", location: "St. Petersburg, FL", scope: "Foundation repair, load-bearing wall removal, kitchen expansion" },
  { type: "Exterior Transformation", location: "Clearwater, FL", scope: "New siding, windows, roofing, and exterior paint" },
  { type: "Interior Remodel", location: "Brandon, FL", scope: "Custom trim, built-in shelving, and interior painting" },
];
...
const clientReviews = [
  {
    author: "David R.",
    location: "Tampa, FL",
    text: "Revitalize Real Estate completely rebuilt my outdated Tampa kitchen, and the results are stunning. Their team showed up on time, stayed on budget, and kept the worksite surprisingly clean. I finally have the kitchen I've always dreamed of.",
  },
  {
    author: "Marcus T.",
    location: "St. Petersburg, FL",
    text: "We hired Revitalize Real Estate for a full bathroom remodel, and the results exceeded every expectation. The attention to detail and premium finish made our master bath feel like a luxury spa. Their project manager kept us informed every single day.",
  },
  {
    author: "Amanda C.",
    location: "Riverview, FL",
    text: "I was nervous about undertaking a whole-home improvement project, but their project manager kept me informed every single day. The transformation is breathtaking. I finally love coming home.",
  },
];
...
const faqsList = [
  {
    q: "What types of residential remodeling projects do you handle?",
    a: "We handle all types of residential remodeling, including whole-home renovations, room additions, kitchen and bathroom remodels, structural work, and exterior upgrades."
  },
  {
    q: "How long does a residential remodel typically take?",
    a: "The timeline depends on the scope of the project. A kitchen remodel may take 4-8 weeks, while a whole-home renovation can take 3-6 months. We provide a clear timeline during the planning phase."
  },
  {
    q: "Do I need permits for my remodeling project?",
    a: "Yes, most residential remodeling projects require permits. Our team handles all permitting and inspections to ensure your project meets local building codes."
  },
  {
    q: "How do I get started?",
    a: "Simply call us at (813) 323-0291 or request a free estimate online. We'll schedule a consultation to discuss your project and provide transparent pricing."
  },
  {
    q: "Do you offer financing options?",
    a: "Yes, we offer flexible financing options to help make your remodeling project more affordable. Contact us for details."
  },
  {
    q: "Are you licensed and insured?",
    a: "Absolutely. Revitalize Real Estate is fully licensed, bonded, and insured for your peace of mind."
  }
];

function ResidentialRemodelingPage() {
  ...
  const jsonLdSchema = {
    ...
    "description": "Expert residential remodeling services in Tampa Bay. Whole-home renovations, room additions, structural work, and interior/exterior upgrades. 20+ years experience. Free estimates.",
    "offers": {
      "@type": "Offer",
      "priceCurrency": "USD",
      "availability": "https://schema.org/InStock",
      "url": "https://revitalizeretampa.com/residential-remodeling"
    }
  };
  ...
  return (
    <main className="bg-background overflow-x-hidden font-sans">
      ...
      <PageHero
        ...
        subtitle="Tampa Bay's Premier Home Transformation & Structural Renovation Experts"
      />
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center justify-between">
          ...
          <div className={`w-full lg:w-[50%] flex flex-col items-start transition-all duration-700 transform ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-6 opacity-0"}`}>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-charcoal mb-6 font-serif leading-tight">
              ...
              <span className="text-copper italic font-serif font-bold">Expert Residential Remodeling</span>
            </h2>

            <div className="text-[1.02rem] text-charcoal-soft/85 font-medium space-y-6 leading-relaxed mb-8">
              <p>
                Your home is more than just a place to live—it's where memories are made, families grow, and life happens. At Revitalize Real Estate, we understand the importance of creating spaces that are not only beautiful but also functional, comfortable, and built to last.
              </p>
              <p>
                With 20+ years of experience, we specialize in residential remodeling projects of all sizes. From whole-home transformations to room additions and structural updates, our team of senior craftsmen delivers exceptional quality, transparent communication, and a stress-free experience.
              </p>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4.5xl font-bold text-charcoal mb-4 font-serif">
              Why Choose Revitalize Real Estate for Your Remodel?
            </h2>
          </div>
      ...
      {/* 4. Our Residential Remodeling Services */}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-charcoal-soft/80 text-sm md:text-base font-medium">
              We offer a full suite of residential remodeling services to transform your home inside and out. Every project is led by senior craftsmen and supported by trusted local trades.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-white/80 text-sm font-medium">
              We make residential remodeling simple and stress-free with our transparent, client-focused process.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4.5xl font-bold text-charcoal font-serif mb-4">
              Recent Residential Remodeling Projects
            </h2>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-charcoal font-serif mb-4">
              What Our Clients Say About Our Residential Remodeling
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            {clientReviews.map((rev, idx) => (
              <div
                key={idx}
                className="bg-white border border-[#efe5da] p-6 rounded-2xl shadow-sm space-y-4 hover:shadow-md transition duration-300"
              >
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                ...
                <p className="text-charcoal-soft/85 text-xs md:text-sm leading-relaxed font-medium italic">
                  "{rev.text}"
                </p>
                <div className="border-t border-[#efe5da]/60 pt-3">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
            ...
            <div className="w-full lg:w-[50%] bg-[#faf8f6] border border-[#efe5da] p-8 md:p-10 rounded-[2rem] shadow-sm flex flex-col items-start space-y-6">
              <h3 className="text-xl font-bold text-charcoal font-serif">Ready to Transform Your Home?</h3>
              <p className="text-sm text-charcoal-soft/80 font-medium leading-relaxed">
                Don't wait to create the home you deserve. Contact Revitalize Real Estate today for a free consultation and estimate.
              </p>
