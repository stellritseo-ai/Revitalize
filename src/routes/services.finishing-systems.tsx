...
export const Route = createFileRoute("/services/finishing-systems")({
  head: () => ({
    title:
      "Finishing & Systems – Drywall, Electrical & Plumbing Coordination, Interior Finishes | Revitalize Real Estate",
    meta: [
      {
        name: "description",
        content:
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 md:p-16 rounded-[2rem] shadow-2xl text-center">
            <div className="inline-flex items-center gap-2 bg-brand-orange/20 border border-brand-orange/30 px-4 py-2 rounded-full mb-8">
              ...
              <span className="text-brand-orange text-xs font-bold uppercase tracking-widest">
                Premium Arizona Finishing
              </span>
            </div>

            <h1 className="text-[35px] font-black text-white mb-6 leading-tight uppercase tracking-tight">
              Perfect Finishes. Seamless Systems. —{" "}
              <span className="text-brand-orange">The Final Touch</span> That Makes All the
              Difference
            </h1>

            <p className="text-white/80 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
              From smooth drywall and professional painting to fully coordinated electrical and
              plumbing systems, Revitalize Real Estate delivers licensed, insured, and bonded
              finishing services across the Tampa Bay area.{" "}
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20 relative z-10">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-6 text-gray-600 text-lg md:text-xl leading-relaxed">
              <p>
                The difference between a good build and a great build is in the finishes — and the
                systems behind the walls. At Revitalize Real Estate, we specialize in the critical
                finishing trades and systems coordination that bring your project to life. We are
      ...
      <section className="py-[100px] px-4 md:px-8">
        <div className="max-w-7xl mx-auto text-center mb-20">
          <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">
            What We Finish & Coordinate
          </span>
          <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">
            Master Interior Systems
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium">
            Flawless surfaces and perfectly integrated plumbing and electrical systems.
          </p>
        </div>
          ...
          {[
            ...
            >
              ...
              <div className="p-10">
                ...
                <Link
                  to={
                    ["Interior & Exterior Painting", "Flooring Installation"].includes(item.title)
      ...
      <section className="py-[100px] px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">
              Why Homeowners Trust Our Finishes
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium">
            ...
            {[
              {
                ...
                desc: "Licensed & Insured – Full legal and financial protection for every finishing project.",
                icon: <Shield />,
              },
              {
                title: "Licensed Sub Coordination",
                desc: "We manage only licensed electricians and plumbers who meet Arizona state requirements.",
                icon: <BadgeCheck />,
              },
              {
                title: "6+ Years Local Experience",
                desc: "We know Florida codes, climate-specific finishes, and material durability.",
                icon: <Clock />,
              },
              {
                title: "Video Meetings & File Uploads",
                desc: "Approve finishes, samples, and track progress remotely from anywhere.",
                icon: <Video />,
              },
              {
                title: "Financing Available",
                desc: "Flexible options for larger finishing and systems projects.",
                icon: <CreditCard />,
              },
              {
                title: "Supplier Backlinks",
                desc: "Full transparency on materials and sourcing from our trusted network.",
                icon: <Search />,
              },
            ].map((benefit, i) => (
              <div
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 font-medium">
              Get clear answers to common finishing and systems queries.
            </p>
          </div>
          ...
          <Accordion.Root type="single" collapsible className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: "Yes. We only coordinate with fully licensed professionals who meet Arizona state requirements.",
              },
              {
                q: "Can you match existing drywall texture?",
                a: "Absolutely. We match orange peel, knockdown, smooth, and other textures seamlessly.",
              },
              {
                q: "Do you offer financing for finishing projects?",
                a: "Yes. Ask us about flexible financing options for larger projects.",
              },
              {
                q: "How long does drywall repair take?",
                a: "Most small repairs are completed in 1–2 days, including drying time between mud coats.",
              },
              {
                q: "Can I see paint colors or flooring samples before ordering?",
                a: "Yes. We offer video meetings, physical samples, and supplier backlinks for full transparency.",
              },
              {
                q: "Do you handle commercial finishing and systems?",
                a: "Yes. We provide drywall, painting, flooring, and sub-coordination for commercial properties.",
              },
            ].map((item, i) => (
              <Accordion.Item
                key={i}
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20">
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-600 text-lg mb-10 leading-relaxed">
              Fill out the form below to initiate your finishing project. From flawless drywall to
              coordinated systems, we provide premium estimates within 24 hours.
            </p>
            ...
            <div className="bg-charcoal p-10 rounded-[3rem] text-white relative overflow-hidden">
              ...
              <div className="absolute top-0 right-0 p-10 opacity-10">
                <Paintbrush className="w-48 h-48" />
              </div>
            </div>
          </div>
