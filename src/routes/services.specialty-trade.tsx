...
export const Route = createFileRoute("/services/specialty-trade")({
  head: () => ({
    title:
      "Specialty Trade Services – Roofing, Flooring, Painting, Concrete & Framing | Revitalize Real Estate",
    meta: [
      {
        name: "description",
        content:
          "Licensed specialty trade contractor in Tampa, FL. Roofing, flooring, interior & exterior painting, concrete work, and framing. Licensed & Insured. Free video consult. Call (813) 945-6736.",
      },
    ],
  }),
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 md:p-16 rounded-[2rem] shadow-2xl text-center">
            <div className="inline-flex items-center gap-2 bg-brand-orange/20 border border-brand-orange/30 px-4 py-2 rounded-full mb-8">
              ...
              <span className="text-brand-orange text-xs font-bold uppercase tracking-widest">
                Premium Arizona Tradecraft
              </span>
            </div>

            <h1 className="text-[35px] font-black text-white mb-6 leading-tight uppercase tracking-tight">
              Precision Trades. Professional Results. —{" "}
              <span className="text-brand-orange">Arizona's Specialty</span> Trade Experts
            </h1>

            <p className="text-white/80 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
              From roofing replacements and concrete driveways to flawless painting and structural
              framing, Revitalize Real Estate delivers licensed, insured, and bonded trade services
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20 relative z-10">
          ...
          <div className="lg:w-1/2">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-8 leading-tight">
              Specialty Trades – The{" "}
              <span className="text-brand-blue-deep underline decoration-brand-orange underline-offset-8">
                Backbone of Every Build
              </span>
            </h2>
            <div className="space-y-6 text-gray-600 text-lg md:text-xl leading-relaxed">
              <p>
                Great construction and remodeling rely on skilled trades. At Revitalize Real Estate
                Construction Group, we don't just manage projects — we perform the critical
                specialty trade work that ensures durability, beauty, and code compliance. We are
                fully licensed (Licensed & Insured), insured, and bonded.
              </p>
              <p className="font-bold text-charcoal">
                Whether you need a new roof, fresh interior paint, a stamped concrete patio, or
                structural framing for an addition, our experienced crew delivers precision
                craftsmanship. No subcontractor runaround. Just quality work, done right.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-[100px] px-4 md:px-8">
        <div className="max-w-7xl mx-auto text-center mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">
            Expert Trade Divisions
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium">
            Master-level execution for the most critical components of your property.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              ...
              <div
                key={i}
                className="group bg-white/5 backdrop-blur-sm border border-white/10 p-10 rounded-[2.5rem] hover:bg-white hover:text-charcoal text-[#FFFFFF] transition-all duration-500"
              >
                <div className="flex items-start gap-6 mb-8">
                  <div className="bg-white/10 w-20 h-20 rounded-2xl flex items-center justify-center text-brand-orange group-hover:bg-charcoal/10 transition-all">
                    {React.cloneElement(capability.icon as React.ReactElement, {
                      className: "w-10 h-10",
                    })}
                  </div>
                  <div>
                    <h4 className="text-brand-orange font-bold uppercase tracking-widest text-xs mb-2">
                      {capability.title}
                    </h4>
                    <h3 className="text-2xl font-black mb-4">{capability.subtitle}</h3>
                  </div>
                </div>
                <p className="opacity-70 group-hover:opacity-100 font-medium leading-relaxed mb-8">
                  {capability.desc}
                </p>
                <div className="flex items-center justify-between pt-6 border-t border-white/10 group-hover:border-charcoal/10">
      ...
      <section className="py-[100px] px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">
              Why Homeowners Trust Our Trades
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium">
            ...
            {[
              {
                ...
                desc: "Licensed & Insured – Full legal and financial protection for every trade project.",
                icon: <Shield />,
              },
              {
                title: "6+ Years Local Experience",
                desc: "We know Arizona materials, soil conditions, and desert climate needs.",
                icon: <Clock />,
              },
              {
                title: "Single Point of Contact",
                desc: "No managing multiple vendors – one call handles all your trade needs.",
                icon: <Users />,
              },
              {
                title: "Video Meetings & File Uploads",
                desc: "Approve samples, colors, and track progress remotely from anywhere.",
                icon: <Video />,
              },
              {
                title: "Financing Available",
                desc: "Flexible options for larger roofing, flooring, or concrete projects.",
                icon: <CreditCard />,
              },
              {
                title: "Supplier Backlinks",
                desc: "Full transparency on materials and sourcing from trusted partners.",
                icon: <Search />,
              },
            ].map((benefit, i) => (
              <div
      ...
      <section className="py-[100px] px-4 md:px-8 mx-[15px] mt-[15px] rounded-[20px] bg-white border border-gray-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">
              Simple, Stress‑Free Trade Services
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 font-medium">
              Get clear answers to common specialty trade queries.
            </p>
          </div>
          ...
          <Accordion.Root type="single" collapsible className="space-y-4">
            {[
              {
                q: "Do I need a licensed contractor for roofing or framing?",
                a: "Yes. Arizona law requires a licensed contractor for roofing, framing, concrete, and most structural work. We are Licensed & Insured.",
              },
              {
                q: "Can you match existing paint colors or textures?",
                a: "Absolutely. We can color-match paint and replicate drywall textures (orange peel, knockdown, smooth).",
              },
              {
                q: "Do you offer financing for roofing or flooring projects?",
                a: "Yes. Ask us about flexible financing options for larger trade projects.",
              },
              {
                q: "How long does a roof replacement take?",
                a: "Typically 1–3 days depending on size and material. We provide a clear timeline before starting.",
              },
              {
                q: "Can I see material samples before ordering?",
                a: "Yes. We offer video meetings, physical samples, and supplier backlinks for full transparency.",
              },
              {
                q: "Do you handle commercial specialty trades?",
                a: "Yes. We perform roofing, flooring, painting, concrete, framing, and drywall for commercial properties.",
              },
            ].map((item, i) => (
              <Accordion.Item
                key={i}
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20">
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-600 text-lg mb-10 leading-relaxed">
              Fill out the form below to initiate your trade project. From small repairs to major
              replacements, we provide premium estimates within 24 hours.
            </p>
